    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Alif sample API",
                    Description = "A simple example ASP.NET Core Rest API for Alif",
                    TermsOfService = new Uri("http://tempuri.org/terms"),
                    Contact = new OpenApiContact
                    {
                        Name = "Aziz Umarov",
                        Email = "aziz.umarov.gm@gmail.com",
                        Url = new Uri("https://ru.stackoverflow.com/users/387032/aziz-umarov?tab=topactivity")
                    },
